...
const deals_1 = require("@hubspot/api-client/lib/codegen/crm/deals");
...
class DealHubspotV3Mapper {
    static toPersistence = (deal) => {
        const simplePublicDeal = new deals_1.SimplePublicObject();
...
exports.default = DealHubspotV3Mapper;
